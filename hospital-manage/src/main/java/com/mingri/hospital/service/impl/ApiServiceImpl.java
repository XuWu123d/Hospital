package com.mingri.hospital.service.impl;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.mingri.hospital.mapper.HospitalSetMapper;
import com.mingri.hospital.mapper.ScheduleMapper;
import com.mingri.hospital.model.HospitalSet;
import com.mingri.hospital.model.Schedule;
import com.mingri.hospital.service.ApiService;
import com.mingri.hospital.util.BeanUtils;
import com.mingri.hospital.util.HttpRequestHelper;
import com.mingri.hospital.util.MD5;
import com.mingri.hospital.util.YyghException;
...
//        paramMap.put("sign", HttpRequestHelper.getSign(paramMap, this.getSignKey()));
    ...
    public boolean saveHospital(String data) {
        ...
        paramMap.put("timestamp", HttpRequestHelper.getTimestamp());
//        paramMap.put("sign", HttpRequestHelper.getSign(paramMap, this.getSignKey()));
        paramMap.put("sign", MD5.encrypt(this.getSignKey()));   //MD5加密
